...
# FusionPBX Settings
domain_name=reg.xxxxx.com                   # hostname, ip_address or a custom value
system_username=admin                       # default username admin
system_password=xxxxxxxxxxxxxxxxxxxxxxxxxxx # random or a custom value
...
switch_token=xxxxxxxxxxxxxxxxxxxxxxxxxxxx   # Get the auth token from https://signalwire.com
...
database_password=xxxxxxxxxxxxxxxxxxxxxxxx  # random or a custom value (safe characters A-Z, a-z, 0-9)
database_repo=official                      # PostgreSQL official, system
database_version=17                         # requires repo official
database_host=10.x.x.x.x                     # hostname or IP address
